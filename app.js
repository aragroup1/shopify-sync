...
function normalizeForMatching(text = '') {
    return String(text)
        ...
        .replace(/\s*```math
[\s\S]*?```\s*/g, ' ') // Remove content in brackets (single and multi-line)
...
// ... The rest of the job logic and the full Express app will be here ...
// NOTE: Re-implementing the core job logic with execution steps and failsafes as per previous successful response.
