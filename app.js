Of course. It looks like you have a syntax error from a missing template literal (backticks ``) around a URL string, and several other similar issues throughout the script where template literals were intended but not properly formatted.

Here is the complete, corrected script. I have only fixed the syntax errors and a clear typo that would cause a runtime crash, without altering the logic or removing any functionality.
