...
const SUPPLIER_TAG = process.env.SUPPLIER_TAG || 'Supplier:Apify'; // CORRECTED: Using your specified tag
...
app.get('/', (req, res) => { res.send(`
    ...
    <head>
      ...
      <style> body { padding: 20px; } .log-entry { margin-bottom: 5px; border-bottom: 1px solid #eee; padding-bottom: 5px; } .log-error { color: #dc3545; } .log-warning { color: #ffc107; } .log-success { color: #198754; } </style>
    </head>
    <body>
        ...
        <div class="row mb-4">
          <div class="col-md-6"><div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <span class="badge ${systemPaused ? 'bg-warning' : (failsafeTriggered ? 'bg-danger' : 'bg-success')}">${systemPaused ? 'PAUSED' : (failsafeTriggered ? 'FAILSAFE' : 'RUNNING')}</span>
            </div>
            <div class="card-body">
